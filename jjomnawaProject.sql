...
select id, name, p_id, depth  from categories order by depth, id;
...
select id, name, p_id, depth from categories order by id;
...
-- 위 2개 entity 만들어야됨
-- header에 breadcrum 포함시키고 js 정리해야됨
